      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          >
            ...
            <div className="group relative rounded-2xl border border-[#374151] bg-[#111827] p-6 transition-all duration-300 hover:border-[#4A73D5]/40 hover:shadow-lg hover:shadow-[#4A73D5]/5">
              {/* Illustration */}
              ...
              <div className="mb-3 inline-flex rounded-full border border-[#4A73D5]/20 bg-[#4A73D5]/10 px-3 py-1">
                <span className="text-xs font-medium text-[#7B9BE0]">
                  Step 1
                </span>
              </div>
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Tell us your volume. We calculate mailboxes and domains. One
                click and your infrastructure is building.
              </p>
            </div>
            ...
            <div className="group relative rounded-2xl border border-[#374151] bg-[#111827] p-6 transition-all duration-300 hover:border-[#4A73D5]/40 hover:shadow-lg hover:shadow-[#4A73D5]/5">
              ...
              <div className="mb-6 flex h-40 items-center justify-center">
                ...
                >
                  ...
                  {/* Indicator arc */}
                  <path
                    d="M 26.1 80.5 A 40 40 0 1 1 93.9 80.5"
                    stroke="#4A73D5"
                    strokeWidth="3"
                    fill="none"
                    strokeLinecap="round"
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Start with 50 mailboxes. Scale to 5,000+. Volume discounts kick
                in automatically. No new contracts.
              </p>
            </div>
            ...
            <div className="group relative rounded-2xl border border-[#374151] bg-[#111827] p-6 transition-all duration-300 hover:border-[#4A73D5]/40 hover:shadow-lg hover:shadow-[#4A73D5]/5">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Plug SMTP credentials into Instantly, Smartlead, or any tool.
                Your infrastructure is ready. Start sending.
              </p>
            </div>
          </div>
        </div>
